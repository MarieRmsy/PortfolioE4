                ...
                <div id="main">
						<div class="inner">
							<section>
								<img src="assets/stuff/virtuozIcon.png" style="float: right; margin: 0 5em;" width="12%" height="12%" />	
								<header class="major">
									<h6  style="
									font-weight: bold;
									">Virtuoz  <nobr class="typeProj">.php</nobr>
									</h6>
								</header>
							</section>
							...
							<div class="row gtr-200">
								...
								<div class="col-6 col-12-medium">
								<img src="assets/stuff/virtuozSite.png" class="virtuozIMG" />	
								</div>
							</div>
